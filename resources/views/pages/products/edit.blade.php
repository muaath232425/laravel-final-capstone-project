                    ...
                    <div class="card-body">
                        <form action="{{ route('brands.update', $brand) }}" method="POST">
                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        HEAD <h5 class="form-title student-info">Brand Information <span><a
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" name="brand_name"
                                                value="{{ old('brand_name', $brand->brand_name) }}" type="text"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" name="price"
                                                    value="{{ old('price', $product->price) }}" type="text"
                                        ...
                                        <div class="col-12">
                                            <div class="student-submit">
                                                <<<<<<< HEAD <button type="submit" class="btn btn-primary">Update</button>
                                            </div>
                                        </div>
                                        =======
